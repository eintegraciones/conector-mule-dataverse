 ...
 *
 */
public enum DataverseErrorTypeDefinition implements ErrorTypeDefinition<DataverseErrorTypeDefinition> {
    ...
    DataverseErrorTypeDefinition(ErrorTypeDefinition<? extends Enum<?>> parent) {
        this.parent = parent;
    }
    
    
    DataverseErrorTypeDefinition() {
