...
echo sed -i.bkp "s/ORG_ID_TOKEN/$1/g" "conector-mule-dataverse"/pom.xml
sed -i.bkp "s/ORG_ID_TOKEN/$1/g" "conector-mule-dataverse"/pom.xml


# Deploying to Exchange
echo "Deploying to Exchange..."

echo mvn -f "conector-mule-dataverse"/pom.xml clean deploy
mvn -f "conector-mule-dataverse"/pom.xml clean deploy
